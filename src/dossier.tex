...
\paragraph{}
Dans le cadre du module de PPP j'ai fais un travail d'analyse sur mes priorités professionnelles. Voici les trois principales trouvées.

\paragraph{Résumé}
Liste de mes principales priorités
\begin{enumerate}
...
\paragraph{Analyse}
Je vais maintenant préciser un peu ces priorités.

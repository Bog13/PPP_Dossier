...
\paragraph{}
Ce dossier est composé de trois grandes parties: le bilan personnel, le projet professionnel et les stratégies d'actions. Dans le sujet, la partie bilan est traitée après le projet. J'ai décidé d'inverser cela car chronologiquement, le bilan personnel est antérieur à l'établissement du projet professionel.
Je me suis beaucoup aidé des resssources disponibles sur moodle: à commencer par la structure du rapport.
...
J'ai ensuite fais connaissance avec l'OS\footnote{\textsc{OS}: Operating System (Système d'exploitation)} Gnu/Linux par pur hasard. J'ai fais alors l'expérience d'une liberté que je ne connaissais pas avec Windows. J'utilisais toujours ce dernier, considérant Gnu/Linux comme une curiosité technologique intéressante. 
...
\begin{tabular}{|l|c|c|}
  ...
  \hline
  Developpeur & travail d'équipe & peu créatif\\
  \hline
...
La contribution au grand projet (tel le projet LibreOffice) n'est pas rémunérer, ou alors sur une courte période: en tous cas on ne peut pas en vivre. Si on décide de contribuer, il faut alors se trouver un autre métier en parallèle.
C'est un travail qui apporte plus de liberté qu'un boulot classique (d'après Chriswot), cependant je vois que ça apporte des contraines financières.
...
Au final, je me rends compte que \textbf{j'ai idéalisé le métier de chercheur} et j'ai oublié les contraintes innérantes au métier.
...
Les cours auquels j'ai participé durant ce semestre m'ont ammené à me poser des questions sur ce que je suis, ce que je veux faire, ce que je peux faire et enfin comment je peux le faire.
Ce dossier en est la synthèse. Il m'a permit de mieux appréhender l'établissement de mon projet professionnel.
